...
A camera with pan/tilt functionality
...
Networking
	...
	software limits?
		...
		latency? Client<->DSP<->Hardware vs Client<->Hardware direct
...
Hardware
	...
	smart phone (android?IOS?) optionally desktop (if web app)
		Web stream in <video> element served by computer vision module
