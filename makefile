...
winheaders :		headers.cpp
	g++ -o $(BIN_DIR)winheaders headers.cpp -lmingw32 -lSDLmain -lSDL -lSDL_image -std=c++0x -lglut -lGL -lGLU -mwindows -I C:/cygwin/usr/include/ -L C:/cygwin/usr/local/lib -I C:/cygwin/usr/include/w32api/ -L C:/Windows/System32/
